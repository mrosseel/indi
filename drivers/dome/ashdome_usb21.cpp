...
uint8_t AshDomeUSB21::CRC(uint8_t crc, uint8_t data)
{
    crc ^= data;
...
int AshDomeUSB21::writeBuf(AshDomeCommand cmd, uint8_t len, uint8_t *buff)
{
...
int AshDomeUSB21::write(AshDomeCommand cmd)
{
    int nbytes_written = 0, rc = -1;
    uint8_t cbuf[4];
    char errstr[MAXRBUF];
...
int AshDomeUSB21::readBuf(AshDomeCommand &cmd, uint8_t len, uint8_t *buff)
{
...
int AshDomeUSB21::read(AshDomeCommand &cmd)
{
    int nbytes_read = 0, rc = -1;
    int err         = 0;
    uint8_t cbuf[4] = { 0 };
